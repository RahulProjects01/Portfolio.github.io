...
export const LinkedIn = (props) => {
  return (
      ...
      >
        <path
          fill={props.fill}
          d="M100.28 448H7.4V149.5h92.78V448zm-46.14-338C24.3 110 0 85.7 0 55.24A55.24 55.24 0 11110.47 55.3C110.47 85.7 86.17 110 54.14 110zM447.8 448h-92.8V302.4c0-34.7-12.3-58.4-43-58.4-23.4 0-37.3 15.7-43.4 30.7-2.2 5.5-2.7 13.2-2.7 20.9V448h-92.7s1.2-260.7 0-287.3h92.7v40.7c-.2.3-.5.7-.7 1h.7v-1c12.3-19 34.4-46.2 83.6-46.2 61 0 106.7 39.7 106.7 125.2V448z"
        />
      </svg>
  )
}
